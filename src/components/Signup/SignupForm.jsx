 ...
 *       touched : true if the field has been touched. By default this will be set when the 
 * field is blurred.
 *       error   : The error for this field if its value is not passing validation.
 *                 Both synchronous, asynchronous, and submit validation errors 
 ...
 * field is blurred.
 *       error   : The error for this field if its value is not passing validation.
 *                 Both synchronous, asynchronous, and submit validation errors will be 
 * reported here.
 *       value   : the input value
 */
 ...
 * reported here.
 */
const renderRetypePasswordField = ({tabIndex, input, type, meta: {touched, error}}) => (
  <div>
    <input
      autoComplete='off'
      placeholder={ I18n.t('signup.repeat_password') }
      type={ type }
      { ...input }
      tabIndex={ tabIndex }
    />
...
const renderRecoveryButtonFields = (fields) => (
  <div>
    <Button
      ...
      className={
        'btn btn-regular' +
        (fields.password.input.value !== fields.password_retype.input.value
          ? 'btn-disabled'
          : ' btn-download') +
        ' grid-100'
      }
      ...
      <form onSubmit={ handleSubmit }>
        <div className='form-fields'>
          <Field
            ...
            placeholder={ I18n.t('signup.acc_name') }
            type='text'
            tabIndex='1'
        ...
        <div className='form-fields savePasswordBox'>
          <div className='download-file'>
            <p className='passwordMessage'>
              {I18n.t('signup.password_warning_1')}
              <span className='boldTextInMessage'>{I18n.t('signup.password_warning_2')}</span>
              {I18n.t('signup.password_warning_3')}
            </p>
            <div className='text-center'>
              <Fields
                names={ ['password', 'password_retype'] }
        ...
        <div className='form-fields margin-btm-20 '>
          <button
            ...
            className={
              'btn ' +
              (invalid || submitting || loadingStatus === LoadingStatus.LOADING
                ? 'btn-disabled'
                : ' btn-regular') +
              ' grid-100 margin-top-18'
            }
        ...
        <div className='form-fields'>
          <p>
            ...
            <a className='text-underline blue-text' href='#' onClick={ onClickLogin }>
              {' '}
